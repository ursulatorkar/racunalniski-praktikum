...
% Nastavim o  koliko prostora izpustimo pod napisom nad sliko ali tabelo.
...
% - napis nad tabelzo: Kvadrat Kubera-Kolam
% - oznaka: table:kubera
% Konec magičnega kvadrata
%   23 & 28 & 21 \\\hline
%   22 & 24 & 26 \\\hline
...
%
% - napis nad tab elo: Pasijonska fasada, Sagrada Família
...
\begin{proof}
      ...
      enaka številu $ \m{M}_2(n)$. 
\end{proof}

Preprost račun pokaže, da je konstanti \ref{eq:mc} analogna konstanta
$ \m{M}_2(n;A,D)$ za magični kvadrat, v katerem so nameščena števila
