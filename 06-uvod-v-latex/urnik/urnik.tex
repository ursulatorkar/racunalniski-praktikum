...
% (Nekoliko lepše izgleda, če v prazno vrstico vstavite % za komentar.)
\noindent
\emph{Okolica} operacije je množica vseh možnih sprememb, ki jih lahko s to operacij
...
\emph{Sistem okolic} je množica vseh možnih sprememb, ki jih lahko z vsemi operacijami i
...
Imamo torej seznam prepovedanih sprememb - \emph{tabujev} in na vsakem koraku za izbran
